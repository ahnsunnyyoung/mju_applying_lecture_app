...
class Lecture(
    ...
    val uniTypeArray: Array<Array<String>> = arrayOf(
        arrayOf("교양필수","선택교양","기초교양","균형교양/교직/자유선택","인문대학","사회과학대학","법과대학","서울주간"),
        arrayOf("교양필수","선택교양","기초교양","균형교양/교직/자유선택","인문대학","사회과학대학","법과대학","서울야간"),
        arrayOf("교양필수","선택교양","기초교양","균형교양/교직/자유선택","자연대학","용인주간"),
        arrayOf("교양필수","선택교양","기초교양","균형교양/교직/자유선택","자연대학","용인야간")
    )
    val majorTypeArray = arrayOf(
        ...
        arrayOf(
            ...
            arrayOf("인문과학","문화와예술","사회과학","자연과학","공학","건강과생활","외국어","컴퓨터"), //기초교양
            arrayOf("기독교의이해와삷","인문학과의만남","문화예술의초대"), //균형교양/교직/자유선택
            arrayOf("국어국문학과","영어영문학과","중어중문학과"), //자연대학
            arrayOf("행정학과","정치외교학과"), //화학
        ),
        arrayOf(
            arrayOf("성경개론","채플","영어","영어회화","기타교양필수"), //교양필수
            arrayOf("선택교양과목"), //선택교양
